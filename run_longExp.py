...
parser.add_argument('--is_training_second', type=int, default=0, help='status')
...
# parser.add_argument('--enc_d', type=int, default=7, help='encoder input size for indiviudal channel')       
# data loader
...
parser.add_argument('--variation', type=int, default=0,help='{1 : VAE， 0： Determisntic}')
parser.add_argument('--theta_n_hidden', type=list, default=[[2,2],[2048,2048]],help='nbeats')
parser.add_argument('--batch_normalization', type=bool, default=True,help='nbeats')
parser.add_argument('--dropout_prob', type=float, default=0.1,help='nbeats')
...
if args.is_training:
    for ii in range(args.itr):
        ...
        setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_lr{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
    ...
    ii = 0
    setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_va{}_ha{}_po{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}'.format(
            args.model_id,
            args.model,
            args.data,
            args.features,
