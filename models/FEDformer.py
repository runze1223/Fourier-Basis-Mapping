...
#             if self.attention:
#                 outputs,attention = self.fedformer( x_enc_i, x_mark_enc, x_dec_i, x_mark_dec)
                
#                 attention_total.append(attention)
#             else:
#                 outputs = self.fedformer( x_enc_i, x_mark_enc, x_dec_i, x_mark_dec)
