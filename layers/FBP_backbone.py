...
class backbone_new_Linear(nn.Module):
    def __init__(self, c_in:int, context_window:int, target_window:int,head_dropout = 0, individual = False, revin = True, affine = True, subtract_last = False,
        ...
        self.head = Flatten_Head_Linear(self.individual, self.n_vars, self.head_nf, target_window, head_dropout=head_dropout)
...
class backbone_new_NLinear(nn.Module):
    def __init__(self, c_in:int, context_window:int, target_window:int,head_dropout = 0, individual = False, revin = True, affine = True, subtract_last = False,
        ...
        self.head = Flatten_Head_NLinear(self.individual, self.n_vars, self.head_nf, target_window, head_dropout=head_dropout)
